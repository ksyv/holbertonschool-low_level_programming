...
<!-- - [C - Variable Arguments](/rltoken/sibNg6fqEJ5uw_wVx71K0Q) 
- [Functions with Variable Argument Lists in C using va_list](/rltoken/ZN6UY0wyqSA3twa7s9cN5Q) -->
...
At the end of this project, you are expected to be able to [explain to anyone](/rltoken/_r8i6_hyAB73kOu9A4N0sw), __without the help of Google__:
